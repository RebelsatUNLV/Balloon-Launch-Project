...
Serial.print(sData.gx); Serial.print(", ");
Serial.print(sData.gy); Serial.print(", ");
Serial.println(sData.gz);
Serial.print("Mag (μT): ");
Serial.print(sData.mx); Serial.print(", ");
Serial.print(sData.my); Serial.print(", ");
Serial.println(sData.mz);
 // Environmental
Serial.print("Temp/Humidity: ");
Serial.print(sData.t1); Serial.print("°C, ");
Serial.print(sData.rh); Serial.println("%");
 // Atmospheric
Serial.print("ASB Temp: ");
Serial.print(ad.t1); Serial.print("°C, ");
Serial.print(ad.t2); Serial.println("°C");
Serial.print("Pressure: ");
Serial.print(ad.p1); Serial.print("kPa, Alt: ");
Serial.print(ad.pa1); Serial.println("m");
...
Serial.print(ad.co2); Serial.println("ppm (raw)");
 // Particulate Matter
Serial.print("PM Levels (μg/m³): ");
Serial.print("1.0="); Serial.print(ad.pm10);
Serial.print(", 2.5="); Serial.print(ad.pm25);
Serial.print(", 4.0="); Serial.print(ad.pm40);
Serial.print(", 10="); Serial.println(ad.pm100);
 // Battery System
Serial.print("Battery: ");
Serial.print(sys.batV); Serial.print("V (");
Serial.print(sys.batPct); Serial.print("%), Solar: ");
Serial.print(sys.sol1V); Serial.print("V, ");
Serial.print(sys.sol2V); Serial.println("V");
 // GPS
Serial.print("GPS: ");
...
Serial.print("m, Sats: "); Serial.println(GPS.satellites);
Serial.println("========================");
 }
if (digitalRead(2) == 0) {
